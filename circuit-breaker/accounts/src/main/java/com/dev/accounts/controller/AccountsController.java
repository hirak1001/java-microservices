...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "Get build information of current build of account microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get java version information of current  account microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Contact information java in case of any issues"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
